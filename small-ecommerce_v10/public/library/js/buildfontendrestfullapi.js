...
class CallApi 
{
  ...
  build(data,func_success,func_fail,method,prefix = "")
  {
    return $.ajax({
      ...
      data:data, 
    //   headers: {
    //     'Authorization': 'Bearer ',
    //     // 'X-Requested-With': 'XMLHttpRequest',
    //     // Thêm các header khác tùy ý
    // },    
      success: (res)=>{        
  ...
  post(data,func_success,func_fail,prefix="")
  {
    return this.create(data,func_success,func_fail,prefix)
  }
